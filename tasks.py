...
class Metting_preperation_task():
    ...
    def industry_analysis_task(self,agent,meeteing_participants,meeting_context):
        return Task(
            description = dedent(f"""\
                ...
                Participants:{meeteing_participants},
    ...
    def meeting_stategy_task(self,agent,meeting_context,meeting_objective):
        return Task(
            description = dedent(f"""\
    ...
    def summary_and_briefing_task(self, agent,meeting_context, meeting_objective):
        return Task(
            description=dedent(f"""\
                ...
                participants with all necessary information and strategies.text=
